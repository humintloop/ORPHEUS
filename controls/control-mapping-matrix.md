...
This matrix connects ORPHEUS project-defined controls to MITRE ATLAS, OWASP LLM Top 10, ISO/IEC 42001 section 9, and EU AI Act high-risk readiness references.
...
| `LLM-GOV-002` | AI Threat Modeling | `AML.T0051`, `AML.T0054`, `AML.T0056`; `LLM01`, `LLM02`, `LLM07`, `LLM08` | 9.1, 9.2, 9.3 | Articles 9, 15, 17 | Evaluation case rationale, mapped threats, tested assumptions |
...
| `LLM-MON-001` | AI Output Monitoring and Incident Detection | `AML.T0051`, `AML.T0054`, `AML.T0056`, `AML.T0057`; `LLM01`, `LLM02`, `LLM07` | 9.1, 9.3 | Articles 12, 15, 72 | Detection indicator, flagged output, incident ticket reference |
| `LLM-OPS-001` | AI Incident Response | `AML.T0051`, `AML.T0054`, `AML.T0056`, `AML.T0057`; `LLM01`, `LLM02`, `LLM07`, `LLM08` | 9.2, 9.3 | Articles 9, 17, 72 | Containment note, remediation action, retest evidence |
